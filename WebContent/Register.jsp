		...
		<table align="center">
			<tr>
				...
				<td><input type="text" name="username" id="username"
					value="2到10位" onfocus="TextOnFocusShow(this.id);"
					onblur="TextOnBlurShow(this.id);" style="color: #999999" /></td>
			</tr>
			<tr>
				<td>口令：</td>
				<td><input type="password" name="userpass" id="userpass"
					value="6-8位，不能与用户ID相同" onfocus="TextOnFocusShow(this.id);"
					onblur="TextOnBlurShow(this.id);" style="color: #999999" /></td>
			</tr>
			<tr>
				<td>确认口令：</td>
			...
			<tr>
				<td>电话：</td>
				<td><input type="text" name="phone" id="userid"
					value="例如：13483929483" onfocus="TextOnFocusShow(this.id);"
					onblur="TextOnBlurShow(this.id);" style="color: #999999" /></td>
			</tr>
			<tr>
